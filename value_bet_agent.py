...
MIN_EV     = float(os.getenv("MIN_EV_PROZENT", "0.03"))
MAX_QUOTE  = float(os.getenv("MAX_QUOTE", "3.50"))
MIN_BOOKIE = int(os.getenv("MIN_BUCHMACHER", "3"))

# Nur Top-Ligen für zuverlässigen Konsens
ERLAUBTE_LIGEN = [
    "Soccer Epl",
