...
MIN_EV     = float(os.getenv("MIN_EV_PROZENT", "0.03"))  # Mindest-EV (0.03 = 3%)
...
def analysiere_value_bets(spiele: list) -> list:
    ...
    # Pro Spiel nur den besten Tipp (höchster EV)
    gesehen = set()
    unique_bets = []
